...
export default function BookingForm() {
  ...
  return (
    <div className="bg-gray-200 py-4 px-4 md:px-6 lg:px-10 w-full">
      <div className="max-w-screen-2xl mx-auto flex flex-col sm:flex-row gap-3 w-full">
        {/* Location */}
        <div className="flex-1 flex items-center border border-gray-200 bg-[var(--primoo-white)] px-4 py-2 rounded-md h-[54px] min-w-0 relative">
          ...
          <div className="flex flex-col leading-tight min-w-0">
            <span className="font-semibold text-sm sm:text-base">Pick-up Location</span>
            <span className="font-bold text-[var(--primoo-dark)] text-xs sm:text-sm truncate">
        ...
        {/* Duration Badge - only show on larger screens */}
        <div className="hidden sm:flex flex-col items-center justify-center h-[54px] w-[54px] rounded-full bg-[var(--primoo-white)] border border-gray-200 text-center flex-shrink-0">
        ...
        {/* Update Button */}
        <button className="h-[54px] px-4 sm:px-6 bg-[var(--primoo-yellow)] hover:bg-[var(--primoo-dark)] rounded-md font-semibold text-sm flex-shrink-0">
          Update
        </button>
      </div>
    </div>
